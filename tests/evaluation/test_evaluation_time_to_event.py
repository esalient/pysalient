...
from pysalient.evaluation import (
    META_KEY_AGGREGATION_COLS,
    META_KEY_Y_LABEL,
    META_KEY_Y_PROBA,
    evaluation,
)
...
class TestTimeToEventBasicFunctionality:
    ...
    def test_multiple_events(self, time_to_event_table):
        ...
        expected_columns = [
            ...
            "count_first_alerts_before_bc",
            "count_first_alerts_after_or_at_bc",
            "median_hour_from_first_alert_to_ab",
        ...
        assert result_dict["median_hour_from_first_alert_to_bc"][0] is not None
        assert result_dict["median_hour_from_first_alert_to_ab"][0] is not None
...
class TestTimeToEventEdgeCases:
    ...
    def test_no_true_positives_at_threshold(self, base_metadata):
        ...
        assert np.isnan(result_dict["median_hour_from_first_alert_to_bc"][0])
...
class TestTimeToEventIntegration:
    ...
    def test_full_pipeline_with_rounding(self, time_to_event_table):
        ...
        time_value = result_dict["median_hour_from_first_alert_to_bc"][0]
    ...
    def test_multiple_thresholds(self, time_to_event_table):
        ...
        for i in range(len(thresholds)):
            assert "median_hour_from_first_alert_to_bc" in result_dict
    ...
    def test_confidence_intervals_with_time_to_event(self, time_to_event_table):
        ...
        assert "median_hour_from_first_alert_to_bc" in column_names
